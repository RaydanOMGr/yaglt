...
// glGetActiveAtomicCounterBufferiv pnames (SPEC §7.7, table 7.8).
...
// glGetActiveUniformsiv pnames (SPEC §7.3.1). Each maps to a GetProgramResource
// property (see table 7.6): TYPE, ARRAY_SIZE, NAME_LENGTH, BLOCK_INDEX, OFFSET,
// ARRAY_STRIDE, MATRIX_STRIDE, IS_ROW_MAJOR, ATOMIC_COUNTER_BUFFER_INDEX.
...
constexpr GLenum GL_FRAMEBUFFER_SRGB = 0x8DB9;       // SPEC §15.1.1 (sRGB drawbuffer decoding)
...
constexpr GLenum GL_CLIP_ORIGIN = 0x9321;
constexpr GLenum GL_CLIP_DEPTH_MODE = 0x9280;
constexpr GLenum GL_NEGATIVE_ONE_TO_ONE = 0x8E27;
constexpr GLenum GL_ZERO_TO_ONE = 0x8E28; // same value as GL_TIMESTAMP (per spec)
