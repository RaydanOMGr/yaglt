...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 457 | **~43.4%** |
| Core profile only (compat-only commands removed) | 570 | 417 | **~73.2%** |
...
466 `gl*` entry points; 457 map to a spec command.
...
glGetUniformBlockIndex, glGetUniformLocation, glGetUniformSubroutineuiv,
...
glGetnCompressedTextureImage, glGetnTexImage, glGetnTextureImage, glHint,
...
glPatchParameteri, glPauseTransformFeedback, glPixelStorei, glPointParameterf,
