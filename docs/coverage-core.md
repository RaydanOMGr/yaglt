...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 452 | **~43.0%** |
| Core profile only (compat-only commands removed) | 570 | 412 | **~72.3%** |
...
461 `gl*` entry points; 452 map to a spec command.
...
glDrawElementsIndirect, glDrawElementsInstanced, glDrawRangeElements, glDrawTransformFeedback,
glDrawTransformFeedbackInstanced, glDrawTransformFeedbackStream,
glDrawTransformFeedbackStreamInstanced, glEnable, glEnableVertexArrayAttrib,
glEnableVertexAttribArray, glEnablei, glEndConditionalRender, glEndQuery, glEndQueryIndexed,
glEndTransformFeedback, glFenceSync, glFinish, glFlush, glFlushState, glFramebufferParameteri,
