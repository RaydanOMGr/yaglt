...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 455 | **~43.3%** |
| Core profile only (compat-only commands removed) | 570 | 415 | **~72.8%** |
...
464 `gl*` entry points; 455 map to a spec command.
...
glMultiDrawElements, glNamedFramebufferParameteri, glNamedFramebufferRenderbuffer,
