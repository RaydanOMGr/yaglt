...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 437 | **~41.5%** |
| Core profile only (compat-only commands removed) | 570 | 399 | **~70.0%** |
...
446 `gl*` entry points; 437 map to a spec command.
...
glFlushState, glFramebufferRenderbuffer, glFramebufferTexture2D, glFrontFace, glGenBuffers,
glGenFramebuffers, glGenProgramPipelines, glGenQueries, glGenQuery, glGenRenderbuffers,
glGenSampler, glGenSamplers, glGenTextures, glGenTransformFeedback, glGenTransformFeedbacks,
