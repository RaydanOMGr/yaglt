...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 559 | **~53.1%** |
| Core profile only (compat-only commands removed) | 570 | 518 | **~90.9%** |
...
570 `gl*` entry points; 559 map to a spec command.
...
glScissor, glScissorArrayv, glScissorIndexed, glScissorIndexedv, glShaderBinary, glShaderSource,
glShaderStorageBlockBinding, glSpecializeShader, glStencilFunc, glStencilFuncSeparate,
glStencilMask, glStencilMaskSeparate, glStencilOp, glStencilOpSeparate, glTexBuffer,
glTexBufferRange, glTexImage1D, glTexImage2D, glTexImage2DMultisample, glTexImage3D,
glTexImage3DMultisample, glTexParameterIiv, glTexParameterIuiv, glTexParameterf,
