...
|----------|-----------:|--------------------------:|---------:|
| Full spec (compat + core) | 490 | 105 | **21.4%** |
| Core profile only (spec − 55 removed commands) | 435 | 105 | **24.1%** |
...
StencilOp, TexImage2D, TexSubImage1D, TexSubImage2D, TexSubImage3D,
