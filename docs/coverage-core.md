...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 562 | **~53.4%** |
| Core profile only (compat-only commands removed) | 570 | 521 | **~91.4%** |
...
573 `gl*` entry points; 562 map to a spec command.
...
glMultiDrawElements, glMultiDrawElementsBaseInstance, glMultiDrawElementsBaseVertex,
glMultiDrawElementsIndirect, glNamedBufferData, glNamedBufferStorage, glNamedBufferSubData,
...
glProgramUniformMatrix4fv, glProvokingVertex, glPushDebugGroup, glQueryCounter, glReadBuffer,
...
glUniformBlockBinding, glUniformMatrix2dv, glUniformMatrix2fv, glUniformMatrix3dv,
glUniformMatrix3fv, glUniformMatrix4dv, glUniformMatrix4fv, glUniformSubroutinesuiv,
