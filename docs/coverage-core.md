...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 409 | **~38.9%** |
| Core profile only (compat-only commands removed) | 570 | 372 | **~65.3%** |
...
418 `gl*` entry points; 409 map to a spec command.
...
glBindBufferBase, glBindBufferRange, glBindBuffersBase, glBindBuffersRange, glBindFramebuffer,
glBindProgramPipeline, glBindRenderbuffer, glBindSampler, glBindSamplers, glBindTexture,
glBindTextureUnit, glBindTextures, glBindTransformFeedback, glBindVertexArray,
...
glClientWaitSync, glClipControl, glColorMask, glCompileShader, glCopyBufferSubData,
...
glDepthMask, glDepthRange, glDepthRangef, glDisable, glDisableVertexArrayAttrib,
glDisableVertexAttribArray, glDisablei, glDispatchCompute, glDispatchComputeIndirect,
glDrawArrays, glDrawArraysIndirect, glDrawArraysInstanced, glDrawBuffers, glDrawElements,
glDrawElementsBaseVertex, glDrawElementsIndirect, glDrawElementsInstanced, glDrawRangeElements,
glEnable, glEnableVertexArrayAttrib, glEnableVertexAttribArray, glEnablei,
glEndConditionalRender, glEndQuery, glEndQueryIndexed, glEndTransformFeedback, glFenceSync,
glFinish, glFlush, glFlushState, glFramebufferRenderbuffer, glFramebufferTexture2D, glFrontFace,
glGenBuffers, glGenFramebuffers, glGenProgramPipelines, glGenQueries, glGenQuery,
...
glSamplerParameteri, glScissor, glScissorIndexed, glScissorIndexedv, glShaderBinary,
glShaderSource, glStencilFunc, glStencilFuncSeparate, glStencilMask, glStencilMaskSeparate,
...
glVertexAttribPointer, glVertexBindingDivisor, glViewport, glViewportIndexedf,
