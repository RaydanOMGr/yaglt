...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 521 | **~49.5%** |
| Core profile only (compat-only commands removed) | 570 | 480 | **~84.2%** |
...
530 `gl*` entry points; 521 map to a spec command.
...
glShaderBinary, glShaderSource, glSpecializeShader, glStencilFunc, glStencilFuncSeparate,
