...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 416 | **~39.5%** |
| Core profile only (compat-only commands removed) | 570 | 378 | **~66.3%** |
...
425 `gl*` entry points; 416 map to a spec command.
...
glDisable, glDisableVertexArrayAttrib, glDisableVertexAttribArray, glDisablei,
