...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 421 | **~40.0%** |
| Core profile only (compat-only commands removed) | 570 | 383 | **~67.2%** |
...
430 `gl*` entry points; 421 map to a spec command.
...
glBindFragDataLocation, glBindFragDataLocationIndexed, glBindFramebuffer, glBindProgramPipeline,
glBindRenderbuffer, glBindSampler, glBindSamplers, glBindTexture, glBindTextureUnit,
glBindTextures, glBindTransformFeedback, glBindVertexArray, glBindVertexBuffer,
glBindVertexBuffers, glBlendColor, glBlendEquation, glBlendEquationSeparate,
