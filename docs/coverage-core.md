...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 419 | **~39.8%** |
| Core profile only (compat-only commands removed) | 570 | 381 | **~66.8%** |
...
428 `gl*` entry points; 419 map to a spec command.
...
glNamedRenderbufferStorageMultisample, glObjectLabel, glObjectPtrLabel,
glPauseTransformFeedback, glPixelStorei, glPointParameterf, glPointParameterfv,
glPointParameteri, glPointParameteriv, glPointSize, glPolygonMode, glPolygonOffset,
glPolygonOffsetClamp, glPrimitiveRestartIndex, glProgramBinary, glProgramParameteri,
