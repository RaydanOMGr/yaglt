...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 547 | **~52.0%** |
| Core profile only (compat-only commands removed) | 570 | 506 | **~88.8%** |
...
558 `gl*` entry points; 547 map to a spec command.
...
glProvokingVertex, glPushDebugGroup, glQueryCounter, glReadBuffer, glReadPixels,
