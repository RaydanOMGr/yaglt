...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 395 | **~37.5%** |
| Core profile only (compat-only commands removed) | 570 | 358 | **~62.8%** |
...
glGetActiveUniformBlockiv, glGetAttachedShaders, glGetAttribLocation, glGetBooleani_v,
...
glGetProgramResourceiv, glGetProgramiv, glGetQueryBufferObjecti64v, glGetQueryBufferObjectiv,
