...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 405 | **~38.5%** |
| Core profile only (compat-only commands removed) | 570 | 368 | **~64.6%** |
...
414 `gl*` entry points; 405 map to a spec command.
...
glBlendFunc, glBlendFuncSeparate, glBlitFramebuffer, glBlitNamedFramebuffer, glBufferData,
