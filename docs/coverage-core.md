...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 440 | **~41.8%** |
| Core profile only (compat-only commands removed) | 570 | 402 | **~70.5%** |
...
449 `gl*` entry points; 440 map to a spec command.
...
glScissorIndexed, glScissorIndexedv, glShaderBinary, glShaderSource, glStencilFunc,
...
glUseProgram, glUseProgramStages, glValidateProgramPipeline, glVertexArrayAttribBinding,
