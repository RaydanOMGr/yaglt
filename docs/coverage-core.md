...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 397 | **~37.7%** |
| Core profile only (compat-only commands removed) | 570 | 360 | **~63.2%** |
...
406 `gl*` entry points; 397 map to a spec command.
...
glGetProgramiv, glGetQueryBufferObjecti64v, glGetQueryBufferObjectiv,
...
glGetRenderbufferParameteriv, glGetSamplerParameteriv, glGetShaderInfoLog, glGetShaderSource,
