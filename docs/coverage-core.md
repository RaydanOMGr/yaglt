...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1068 | 594 | **~55.6%** |
| Core profile only (compat-only commands removed) | 586 | 553 | **~94.4%** |
...
605 `gl*` entry points; 594 map to a spec command.
...
glGetObjectPtrLabel, glGetProgramBinary, glGetProgramInfoLog, glGetProgramInterfaceiv,
...
glGetProgramResourceiv, glGetProgramStageiv, glGetProgramiv, glGetQueryBufferObjecti64v,
glGetQueryBufferObjectiv, glGetQueryBufferObjectui64v, glGetQueryBufferObjectuiv,
glGetQueryIndexediv, glGetQueryObjecti64v, glGetQueryObjectiv, glGetQueryObjectui64v,
glGetQueryObjectuiv, glGetQueryiv, glGetRenderbufferParameteriv, glGetSamplerParameterIiv,
glGetSamplerParameterIuiv, glGetSamplerParameterfv, glGetSamplerParameteriv, glGetShaderInfoLog,
