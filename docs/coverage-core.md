...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 417 | **~39.6%** |
| Core profile only (compat-only commands removed) | 570 | 379 | **~66.5%** |
...
426 `gl*` entry points; 417 map to a spec command.
...
glClientWaitSync, glClipControl, glColorMask, glColorMaski, glCompileShader,
