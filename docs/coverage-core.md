...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 532 | **~50.6%** |
| Core profile only (compat-only commands removed) | 570 | 491 | **~86.1%** |
...
541 `gl*` entry points; 532 map to a spec command.
...
glMinSampleShading, glMultiDrawArrays, glMultiDrawArraysIndirect, glMultiDrawElements,
...
glReadPixels, glRenderbufferStorage, glResumeTransformFeedback, glSampleCoverage, glSampleMaski,
