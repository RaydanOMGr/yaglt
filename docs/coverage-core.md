...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 423 | **~40.2%** |
| Core profile only (compat-only commands removed) | 570 | 385 | **~67.5%** |
...
432 `gl*` entry points; 423 map to a spec command.
...
glProgramParameteri, glProvokingVertex, glReadBuffer, glReadPixels, glRenderbufferStorage,
