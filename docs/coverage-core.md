...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1068 | 588 | **~55.1%** |
| Core profile only (compat-only commands removed) | 586 | 547 | **~93.3%** |
...
599 `gl*` entry points; 588 map to a spec command.
...
glGetUniformLocation, glGetUniformSubroutineuiv, glGetUniformdv, glGetUniformfv, glGetUniformiv,
glGetUniformuiv, glGetVertexArrayIndexed64iv, glGetVertexArrayIndexediv, glGetVertexArrayiv,
