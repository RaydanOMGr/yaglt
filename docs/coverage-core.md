...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 561 | **~53.3%** |
| Core profile only (compat-only commands removed) | 570 | 520 | **~91.2%** |
...
572 `gl*` entry points; 561 map to a spec command.
...
glReadPixels, glReadnPixels, glRenderbufferStorage, glRenderbufferStorageMultisample,
