...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 436 | **~41.4%** |
| Core profile only (compat-only commands removed) | 570 | 398 | **~69.8%** |
...
445 `gl*` entry points; 436 map to a spec command.
...
glColorMask, glColorMaski, glCompileShader, glCopyBufferSubData, glCopyTexImage1D,
glCopyTexImage2D, glCreateBuffers, glCreateFramebuffers, glCreateProgram,
