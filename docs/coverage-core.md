...
|----------|---------:|--------------------------:|---------:|
| Full spec (compat + core) | 1052 | 549 | **~52.2%** |
| Core profile only (compat-only commands removed) | 570 | 508 | **~89.1%** |
...
560 `gl*` entry points; 549 map to a spec command.
...
glMultiDrawElements, glMultiDrawElementsBaseInstance, glMultiDrawElementsIndirect,
glNamedBufferData, glNamedBufferStorage, glNamedBufferSubData, glNamedFramebufferParameteri,
