...
X(eglChooseConfig, EGLBoolean, (EGLDisplay dpy, const EGLint* attrib_list, EGLConfig* configs, EGLint config_size, EGLint* num_config), (dpy, attrib_list, configs, config_size, num_config), EGL_FALSE, 1)
...
X(eglBindAPI, EGLBoolean, (EGLenum api), (api), EGL_FALSE, 1)
